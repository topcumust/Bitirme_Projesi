...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "registerUser";
    ...
    void addUser(User user) {
        ...
        values.put(KEY_NAME, user.getUser_Name()); // Contact Name
        values.put(KEY_PASSWORD, user.getUser_Password()); // Contact Phone
    ...
    public boolean checkUser(String UserName,String Password)
    {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_USERS, new String[] { KEY_ID,
                        KEY_NAME, KEY_PASSWORD }, KEY_NAME+"=?"+ " and " +KEY_PASSWORD+"=?",
    ...
    public int updateUser(User user) {
        ...
        values.put(KEY_PASSWORD, user.getUser_Password());
